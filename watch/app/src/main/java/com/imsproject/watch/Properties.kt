...
const val TREE_RING_OPENING_ANGLE = 66f
const val TREE_RING_ANGLE_STEP = 360f / (PACMAN_ROTATION_DURATION / 16f)
const val TREE_RING_START_ANGLE = -90f + PACMAN_MOUTH_OPENING_ANGLE / 2f
const val TREE_RING_SWEEP_ANGLE = 360f - PACMAN_MOUTH_OPENING_ANGLE
const val TREE_PARTICLE_CAGE_STROKE_WIDTH = 6f
const val TREE_SHRINK_ANIMATION_DURATION = (((180f - PACMAN_MOUTH_OPENING_ANGLE*2f) / 360f) * PACMAN_ROTATION_DURATION).toInt()
const val TREE_REWARD_SIZE_BONUS = 0.008f
...
fun initProperties(screenWidth: Int){
    ...
    TREE_PARTICLE_DISTANCE_FROM_CENTER = SCREEN_RADIUS * 0.835f

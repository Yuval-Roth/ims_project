...
const val PACMAN_PARTICLE_CAGE_STROKE_WIDTH = 4f
const val PACMAN_SHRINK_ANIMATION_DURATION = (((180f - PACMAN_MOUTH_OPENING_ANGLE*2f) / 360f) * PACMAN_ROTATION_DURATION).toInt()
const val PACMAN_REWARD_SIZE_BONUS = 0.008f
val PACMAN_PARTICLE_COLOR = Color(0xFFF3D3C3)
const val PACMAN_PARTICLE_ANIMATION_MAX_DURATION = 750
const val PACMAN_PARTICLE_ANIMATION_MIN_DURATION = 150
var PACMAN_PARTICLE_RADIUS = 0f
var PACMAN_PARTICLE_DISTANCE_FROM_CENTER = 0f
...
const val TREE_RING_SWEEP_ANGLE = 360f - TREE_RING_OPENING_ANGLE
const val TREE_PARTICLE_CAGE_STROKE_WIDTH = 6f
const val TREE_PARTICLE_ANIMATION_MAX_DURATION = 750
const val TREE_PARTICLE_ANIMATION_MIN_DURATION = 150
const val TREE_PARTICLE_RELATIVE_DISTANCE_FROM_CENTER = 0.83f
const val TREE_RING_RELATIVE_RADIUS = 0.45f
var TREE_RING_RADIUS = 0f
var TREE_PARTICLE_DISTANCE_FROM_CENTER = 0f
var TREE_PARTICLE_RADIUS = 0f
var TREE_SUN_RADIUS = 0f
var TREE_WATER_DROPLET_RADIUS = 0f

// =================== Waves ===================== |

const val WAVE_MAX_ANIMATION_DURATION = 5000
const val WAVE_MIN_ANIMATION_DURATION = 1500
const val WAVE_VISIBLE_AMOUNT = 0.4f
var WAVE_LEFT_STARTING_POSITION = Offset(0f,0f)
var WAVE_RIGHT_STARTING_POSITION = Offset(0f,0f)
var WAVE_OUTER_WIDTH = 0f
...
fun initProperties(screenWidth: Int){
    ...
    // Pacman
    PACMAN_PARTICLE_RADIUS = SCREEN_RADIUS * 0.02f
    PACMAN_PARTICLE_DISTANCE_FROM_CENTER = SCREEN_RADIUS * 0.88f
    PACMAN_MAX_SIZE = SCREEN_RADIUS * 0.7f

    // Tree
    TREE_WATER_DROPLET_RADIUS = SCREEN_RADIUS*0.06f
    TREE_SUN_RADIUS = SCREEN_RADIUS*0.075f
    TREE_PARTICLE_RADIUS = SCREEN_RADIUS*0.075f
    TREE_PARTICLE_DISTANCE_FROM_CENTER = SCREEN_RADIUS * TREE_PARTICLE_RELATIVE_DISTANCE_FROM_CENTER
    TREE_RING_RADIUS = SCREEN_RADIUS * TREE_RING_RELATIVE_RADIUS

    // Waves
    WAVE_OUTER_WIDTH = SCREEN_RADIUS * 1.15f
    WAVE_LEFT_STARTING_POSITION = Offset(-WAVE_OUTER_WIDTH*WAVE_VISIBLE_AMOUNT, 0f)
    WAVE_RIGHT_STARTING_POSITION = Offset(2*SCREEN_RADIUS - WAVE_OUTER_WIDTH*(1-WAVE_VISIBLE_AMOUNT), 0f)
}
